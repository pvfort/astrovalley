...
- 2-4 players
- Top-down movement
- Observatory telescope workflow with calibration costs, observation-time gating, and an alignment minigame affected by weather quality
...
- Enter the observatory annex, calibrate the telescope using required items, then consume observation time via the alignment minigame and verify quality-based XP/data rewards
